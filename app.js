...
async function openEditWeek(week) {
  ...
  $('#saveWeek').addEventListener('click', async () => {
    ...
    const selected = new Set(is_finale ? [] : [...document.querySelectorAll('[data-eliminated-pair]:checked')].map((input) => input.dataset.eliminatedPair));
